...
describe('prune', () => {
  ...
  describe('when valid S3 options are specified', () => {
    ...
    describe('and when prune options show pruning files everyday', () => {
      ...
      beforeEach(async() => {
        await uploadFixtureToTestS3Bucket('backup-20220402000000.tar.bz2', backupFileName);
      });
  ...
  describe('when valid GCS options are specified', () => {
    ...
    describe('and when prune options show pruning files everyday', () => {
      ...
      beforeEach(async() => {
        await uploadFixtureToTestGCSBucket('backup-20220402000000.tar.bz2', backupFileName);
      });
