...
**Note**: weseek/mongodb-awesome-backup always used S3 path-style addressing. mongodb-backup defaults to virtual-hosted-style addressing, so if you use a self-hosted S3-compatible endpoint (e.g. MinIO), set `AWS_FORCE_PATH_STYLE=true`.
