 ...
 *   --mongodb-host                                   Specifies the resolvable hostname of the MongoDB deployment. By default, `backup` attempts to connect to a MongoDB instance running on the "mongo" on port number 27017. (default: "mongo")
